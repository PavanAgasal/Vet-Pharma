...
import com.example.owner.Prevalant.Prevalent;
...
public class LoginAdmin extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.child("Admins").child(phone).exists())
                {
                    ...
                    if (userData.getPhone().equals(phone))
                    {
                        ...
                        {
                            Toast.makeText(LoginAdmin.this,"Welcome Admin..!",Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
    ...
    private void loginAdmin()
    {
        ...
        {
            Toast.makeText(LoginAdmin.this,"None of the fields should be empty",Toast.LENGTH_LONG).show();
        }
    }
